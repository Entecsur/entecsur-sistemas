...
class Pago_model extends CI_Model
{
	...
	public function obtner_preinscritos($idpersona = "")
	{
	...
	public function insert_pago($pago =array(),$pago_evento =array()){
		$this->db->trans_start();
		...
		for($i = 0;$i < count($pago_evento['precios']);$i++){
			...
			$this->db->insert('doc_pago_evento',$pevento);

			
			//return false;
		}
		//print_r($pevento); exit;
