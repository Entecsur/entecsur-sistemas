...
<body>
			...
			<div class="evt-body">
				<div class="evt-contenido">
						...
						<?php if($this->session->flashdata('Message')!=''){echo $this->session->flashdata('Message');}?>
							...
							<?php 
							$ruta = "home/usuarios/editar/".$persona[0]['idpersona'];
							$url = base_url($ruta);
							...
							<div class="input-content">
								...
								<div class="field-content">
									<?php echo form_input(array('class' => 'field-event form-control','name' => 'evt-nombrep', 'value' => $persona[0]["nom_part"],'id' => 'evt-nombrep'))?>
							...
							<div class="input-content">
								...
								<div class="field-content">
									<?php echo form_input(array('class' => 'field-event form-control','name' => 'evt-apellidop','value' => $persona[0]["ape_pater"],'id' => 'evt-apellidop'))?>
								</div>
							</div>
							...
							<div class="input-content">
								...
								<div class="field-content">
									<?php echo form_input(array('class' => 'field-event form-control','name' => 'evt-apellidom','value' => $persona[0]["ape_mater"],'id' => 'evt-apellidom'))?>
								</div>
							</div>
							...
							<div class="input-content">
								...
								<div class="field-content">
									<?php echo form_input(array('class' => 'field-event form-control','name' => 'evt-dnip','value' => $persona[0]["doc_id"],'id' => 'evt-dnip' ))?>
								</div>
							</div>
							...
							<div class="input-content">
								...
								<div class="field-content">
									<?php echo form_input(array('class' => 'field-event form-control','name' => 'evt-telefonop','value' => $persona[0]["telf"],'id' => 'evt-telefonop'))?>
								</div>
							</div>
							...
							<div class="input-content">
								...
								<div class="field-content">
									<?php echo form_input(array('class' => 'field-event form-control','name' => 'evt-email','value' => $persona[0]["correo"],'id'=> 'evt-email'))?>
								</div>
							</div>
							...
							<input type="hidden" name="evt-iduser" value="<?php echo $persona[0]['id_usuario']?>">
							<div class="input-content">
								<div class="label-content">
									<?php echo form_label('Usuario');?>
								</div>
								<div class="field-content">
									<?php echo form_input(array('class' => 'field-event form-control','name' => 'evt-usuario','value' => $persona[0]["usuario_nom"],'id'=> 'evt-usuario'))?>
								</div>
							</div>
							...
							<div class="input-content">
							<input type="hidden" name="evt-opcion" value="edit">
								<hr>
									Privilegios
								<hr>
							</div>
							...
							<div class="input-content">
								<table class="table table-bordered">
									...
									<?php for($i = 0; $i <count($listpriv); $i++){
										...
										{
											if($listpriv[$i]['idprivilegios'] == $persona[$j]['privilegio_idprivilegios'])
											{
												$chk=" checked";
												break;
											}
									...
									?>
									<tr>
										<?php echo "<td><input type='checkbox' value='".$listpriv[$i]['idprivilegios']."'".$chk."  name='evt-privilegios[]'></td>";?>
							...
							<input type="hidden" class="evt-idpersona" name="evt-idpersona" id="evt-idpersona" value="<?php echo $persona[0]['idpersona']?>" >
			...
			$(document).on("ready",function(){
				var cbosexo = "<?php echo $persona[0]['sexo']?>";
				var cbodistrito = "<?php echo $persona[0]['distrito_id_distrito']?>";
				var cboprocedencia = "<?php echo $persona[0]['procedencia_id_proce']?>";
				var cbocargo = "<?php echo $persona[0]['id_Cargo']?>";
				$(".field-content #evt-cbosex").val(cbosexo);
				$(".field-content #evt-cbodistrito").val(cbodistrito);
				$(".field-content #evt-cboprocedencia").val(cboprocedencia);
				$(".field-content #evt-cbocargo").val(cbocargo);
