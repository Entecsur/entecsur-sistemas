			...
			<div class="evt-body">
				<div class="evt-contenido">
						...
						<div class="evt-search">
							...
							?><div class="evt-input-search"><?php echo form_input(array('class' => 'evt-buscar form-control','id' => 'evt-buscar-usuario','name' => 'evt-buscar-usuario','placeholder' => 'Buscar Usuarios'));?></div>
